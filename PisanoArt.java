...
public class PisanoArt  extends JPanel{
    ...
    /*  Scanner sc = new Scanner(System.in);
        ...
        String modString = JOptionPane.showInputDialog(input,"This program will draw a shape based on {Fibconacci sequence} modulus n.\nEnter the divisor, n. --->");
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("Inspired from A New Way to Look at Fibonacci Numbers by Jacob Yatsko",5,getHeight()-18);
        g.drawString("Link: https://youtu.be/o1eLKODSCqw", 30, getHeight()-5);
        g.drawString("Run the program again with another number and see what happens!", 5, 10);
